        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 mb-4">
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={handleSave} disabled={saving || !editName.trim()}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-300 rounded-lg transition-colors">
