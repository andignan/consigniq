...
const CATEGORY_CONFIGS: Record<string, CategoryConfig> = {
  'Clothing & Shoes': {
    ...
    searchTerms: (name, desc) => `${name} ${desc ?? ''} clothing`.trim(),
    priceGuidance:
  ...
  'Furniture': {
    label: 'Furniture',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} furniture`.trim(),
    priceGuidance:
  ...
  'Jewelry & Silver': {
    ...
    searchTerms: (name, desc) => `${name} ${desc ?? ''} jewelry`.trim(),
    priceGuidance:
  ...
  'China & Crystal': {
    label: 'China & Crystal',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} china crystal`.trim(),
    priceGuidance:
  ...
  'Collectibles & Art': {
    ...
    searchTerms: (name, desc) => `${name} ${desc ?? ''} collectible`.trim(),
    priceGuidance:
  ...
  'Electronics': {
    label: 'Electronics',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} used`.trim(),
    priceGuidance:
  ...
  'Books & Games': {
    label: 'Books & Games',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} book`.trim(),
    priceGuidance:
  ...
  'Toys': {
    label: 'Toys',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} toy`.trim(),
    priceGuidance:
  ...
  'Tools': {
    label: 'Tools',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} used tool`.trim(),
    priceGuidance:
  ...
  'Luxury & Designer': {
    ...
    searchTerms: (name, desc) => `${name} ${desc ?? ''} authentic`.trim(),
    priceGuidance:
  ...
  'Kitchen & Home': {
    label: 'Kitchen & Home',
    searchTerms: (name, desc) => `${name} ${desc ?? ''} kitchen home`.trim(),
    priceGuidance:
  ...
  Other: {
    label: 'Other',
    searchTerms: (name, desc) => `${name} ${desc ?? ''}`.trim(),
    priceGuidance:
